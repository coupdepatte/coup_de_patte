 ...
 */
class getDescriptionArticleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DescriptionArticleRepository' shared autowired service.
     *
     * @return \App\Repository\DescriptionArticleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DescriptionArticleRepository.php';

        return $container->privates['App\\Repository\\DescriptionArticleRepository'] = new \App\Repository\DescriptionArticleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
