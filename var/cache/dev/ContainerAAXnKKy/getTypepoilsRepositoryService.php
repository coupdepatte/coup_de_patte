 ...
 */
class getTypepoilsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypepoilsRepository' shared autowired service.
     *
     * @return \App\Repository\TypepoilsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypepoilsRepository.php';

        return $container->privates['App\\Repository\\TypepoilsRepository'] = new \App\Repository\TypepoilsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
