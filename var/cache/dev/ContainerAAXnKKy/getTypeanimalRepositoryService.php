 ...
 */
class getTypeanimalRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeanimalRepository' shared autowired service.
     *
     * @return \App\Repository\TypeanimalRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeanimalRepository.php';

        return $container->privates['App\\Repository\\TypeanimalRepository'] = new \App\Repository\TypeanimalRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
