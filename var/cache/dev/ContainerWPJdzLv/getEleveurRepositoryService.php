 ...
 */
class getEleveurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EleveurRepository' shared autowired service.
     *
     * @return \App\Repository\EleveurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EleveurRepository.php';

        return $container->privates['App\\Repository\\EleveurRepository'] = new \App\Repository\EleveurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
