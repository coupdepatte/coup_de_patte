...
#[Route('/gestion/animal')]
class GestionAnimalController extends AbstractController
{
    #[Route('/gestion_animal', name: 'app_gestion_animal_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_gestion_animal_new', methods: ['GET', 'POST'])]
    public function new(Request $request, AnimalRepository $animalRepository): Response
    {
        $animal = new Animal();
        $form = $this->createForm(AnnonceType::class, $animal);
        ...
        return $this->renderForm('gestion_animal/new.html.twig', [
            'animal' => $animal,
            'form' => $form,
        ]);
    }

    #[Route('/{idAnimal}', name: 'app_gestion_animal_show', methods: ['GET'])]
    public function show(Animal $animal): Response
    {
        return $this->render('gestion_animal/show.html.twig', [
            'animal' => $animal,
        ]);
    }

    #[Route('/{idAnimal}/edit', name: 'app_gestion_animal_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('dashboard/delete/{idAnimal}', name: 'app_gestion_animal_delete', methods: ['POST'])]
